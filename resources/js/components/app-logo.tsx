    ...
    return (
        <>
            <a href="/" className="flex items-center gap-2">
                ...
                <div className="text-sidebar-primary-foreground ml-1 grid flex-1 text-left text-sm md:text-base">
                    <span className="mb-0.5 truncate leading-none font-semibold">Affiliate Jago Jualan</span>
                </div>
            </a>
        </>
    );
