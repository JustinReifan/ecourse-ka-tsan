        ...
        <div className="group hover:border-primary/30 hover:shadow-primary/10 hover-scale-100 from-card/50 to-card border-primary/30 relative rounded-xl border bg-gradient-to-r p-4 backdrop-blur-sm transition-all duration-300 hover:shadow-2xl">
            ...
            <div className="relative flex items-center space-x-4">
                    ...
                    <div
                        className={`flex h-10 w-10 items-center justify-center rounded-full text-sm font-bold transition-all duration-300 ${
                            module.is_completed
                                ...
                                : 'group-hover:border-primary/50 text-primary bg-primary/10 border-primary/30 border-2'
                        }`}
                    >
                ...
                <div className="min-w-0 flex-1">
                    <h3 className="group-hover:text-primary text-foreground truncate font-semibold transition-colors duration-300">{module.name}</h3>
                        ...
                        <div className="grid gap-8 lg:grid-cols-3 lg:gap-12">
                            ...
                            <div className="space-y-6 lg:col-span-2">
                                <div className="animate-fade-in">
                                    <h1 className="text-foreground mb-4 text-4xl leading-tight font-bold lg:text-5xl">
                                    ...
                                    {course.description && (
                                        <p className="text-muted-foreground max-w-3xl text-lg leading-relaxed">{course.description}</p>
                                    )}
                                </div>

                                {/* Course Stats */}
                                <div className="border-primary/30 flex flex-wrap gap-6 border-t border-b py-6">
                            ...
                            <div className="hidden lg:block">
                                <div className="sticky top-8">
                                    <div className="group from-card/50 to-card relative overflow-hidden rounded-2xl border border-neutral-800 bg-gradient-to-br">
                                        ...
                                        <div className="absolute right-4 bottom-4 left-4">
                                            <div className="mb-2 flex items-center justify-between">
                                                <span className="text-primary-foreground text-sm font-medium">Progress</span>
                                                <span className="text-primary-foreground text-sm font-bold">{course.completion_percentage}%</span>
                                            </div>
                                            <div className="h-2 w-full overflow-hidden rounded-full bg-black/40 backdrop-blur-sm">
                                                <div
                ...
                <div className="mx-auto max-w-6xl px-4 pb-16">
                    <div className="space-y-8">
                        <div className="text-center lg:text-left">
                            ...
                            <p className="text-muted-foreground">Expand sections to view individual modules</p>
                        </div>
                                ...
                                <div key={sectionIndex} className="animate-fade-in" style={{ animationDelay: `${sectionIndex * 100}ms` }}>
                                    <Collapsible open={openModules.includes(sectionIndex)} onOpenChange={() => toggleModule(sectionIndex)}>
                                        <CollapsibleTrigger className="group w-full">
                                            <div className="hover:border-primary hover:shadow-primary/5 bg-card border-primary/30 flex items-center justify-between rounded-xl border p-6 transition-all duration-300 hover:shadow-lg">
                                                <div className="flex items-center space-x-4">
                                                    ...
                                                    <div className="text-left">
                                                        <h3 className="group-hover:text-primary text-foreground text-xl font-semibold transition-colors duration-300">
                                                            {section.title}
                                                        </h3>
                                                ...
                                                <ChevronDown
                                                    className={`group-hover:text-primary text-foreground h-6 w-6 transition-all duration-300 ${openModules.includes(sectionIndex) ? 'rotate-180' : ''}`}
                                                />
                                            </div>
                                        </CollapsibleTrigger>
