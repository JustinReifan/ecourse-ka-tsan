            ...
            render: (_: any, voucher: Voucher) => (
                <div className="flex items-center gap-2">
                    ...
                    {voucher.max_discount_amount && (
                        <div className="font-mono text-xs text-gray-400">Max: Rp {voucher.max_discount_amount.toLocaleString()}</div>
                    )}
                </div>
            ),
        },
            ...
            render: (_: any, voucher: Voucher) => (
                <div className="flex items-center gap-2">
                    <div className="text-center">
                        ...
                        <div className="bg-primary/20 mt-1 h-2 w-16 rounded-full">
                            <div
                    ...
                    >
                        <div
                            className={`mr-2 h-2 w-2 rounded-full ${
                                actualStatus === 'active' ? 'animate-pulse bg-white' : actualStatus === 'expired' ? 'bg-red-200' : 'bg-gray-400'
                            }`}
                        ></div>
                        {actualStatus}
                    </Badge>
